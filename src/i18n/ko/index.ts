...
export default {
  ...
  'clipboard copied!': '클립보드에 복사되었어요!',
  'select language': '언어',
  expand: '펼치기',
  'how to use?': '어떻게 쓰나요?',
  'did you like this page?': '이 페이지가 마음에 들었나요?',
  'please donate': '커피 한잔 부탁해요 :)',
  category: {
    all: '모두',
  ...
  desc: {
    ...
    lipstick: 'UI, 스타일 변경',
    tada: '프로젝트 시작',
    white_check_mark: '테스트 변경',
    lock: '보안 작업',
    bookmark: '릴리즈 / 버전 태그',
    rotating_light: '컴파일러 또는 린터(linter) 경고 수정',
    construction: '작업 진행 중',
    green_heart: 'CI 빌드 고침',
    arrow_down: '종속성(디펜던시) 다운그레이드',
    arrow_up: '종속성(디펜던시) 업그레이드',
    pushpin: '종속성(디펜던시) 버전 고정',
    construction_worker: 'CI 빌드 시스템 변경',
    chart_with_upwards_trend: '코드 분석 및 추정 변경',
    recycle: '리팩토링',
    ...
    loud_sound: '로그 변경',
    mute: '로그 제거',
    busts_in_silhouette: '기여자 변경',
    children_crossing: '사용자 경험 및 사용성 향상',
    building_construction: '아키텍쳐 변경',
    iphone: '반응형 디자인 작업',
    clown_face: '목업 작업',
    egg: '이스터 에그 변경',
    see_no_evil: '.gitignore 변경',
    camera_flash: '스냅샷 변경',
    alembic: '실험(실험적인 기능) 시도',
    mag: 'SEO 개선',
    label: '타입 변경',
    seedling: '시드 파일 변경',
    triangular_flag_on_post: '피쳐 플래그(특정 기능 on/off) 변경',
    goal_net: '오류 잡음(Catch)',
    dizzy: '애니메이션 또는 트랜지션 변경',
    wastebasket: '만료(deprecated) 코드 삭제',
